            ...
            </table>
            {
                ...
                <form action={addCar}>
                    ...
                    <div className="flex items-center w-1/2 my-2">
                        ...
                        <input type="picture" required id="picture" name="picture" placeholder="Url For Picture" className="bg-white border-2 border-gray-200 rounded w-full p-2 text-gray-700 focus:outline-none focus:border-blue-400"/>
                    </div>
                    <div className="flex items-center w-1/2 my-2">
                        <label className="w-auto block text-gray-700 pr-4" htmlFor="seats">Seat</label>
                    ...
                    <div className="flex items-center w-1/2 my-2">
                        ...
                        <input type="number" required id="smallbags" name="smallbags" placeholder="4" min={0} max={10} className="bg-white border-2 border-gray-200 rounded w-auto p-2 text-gray-700 focus:outline-none focus:border-blue-400"/>
                    </div>
                    <div className="flex items-center w-1/2 my-2">
                    <label className="w-auto block text-gray-700 pr-4" htmlFor="dayrate">Day Rate</label>
                        <input type="text" required id="dayrate" name="dayrate" placeholder="Daily rate (including insurance)" className="bg-white border-2 border-gray-200 rounded w-auto p-2 text-gray-700 focus:outline-none focus:border-blue-400"/>
                    </div>
